...
const stubCreateBarcodeSuccessThenCreateBarcodeFailure = (): Promise<unknown> => {
  return Promise.all([
    stubFor({
      scenarioName: 'createBarcodeThenFail',
      requiredScenarioState: 'Started',
      newScenarioState: 'firstBarcodeCreated',
      request: {
        method: 'POST',
        urlPattern: '/send-legal-mail/barcode',
        headers: {
    ...
    stubFor({
      scenarioName: 'createBarcodeThenFail',
      requiredScenarioState: 'firstBarcodeCreated',
      request: {
        method: 'POST',
        urlPattern: '/send-legal-mail/barcode',
        headers: {
...
export default {
  ...
  stubCreateBarcodeSuccessThenCreateBarcodeFailure,
}
